...
module.exports = {
    ...
    onStart: async function ({ api, event, args }) {
        ...
        try {
            const bardResponse = await axios.get(`https://gem2-9b-it-njiv.vercel.app/api?ask=${encodeURIComponent(question)}`);
            ...
            gttsInstance.save(gttsPath, function (error) {
                if (error) {
                    ...
                    api.sendMessage({ body: "🗣️ 𝗩𝗼𝗶𝗰𝗲 𝗔𝗻𝘀𝘄𝗲𝗿:", attachment: fs.createReadStream(gttsPath) }, threadID);
                }
            });
...
async function convertImageToText(imageURL) {
    try {
        const response = await axios.get(`https://img2txt-bien.vercel.app/?image=${encodeURIComponent(imageURL)}`);
...
function formatFont(text) {
    const fontMapping = {
        ...
        l: "𝗅", m: "𝗆", n: "𝗇", o: "𝗈", p: "𝗉", q: "𝗊", r: "𝗋", s: "𝗌", t: "𝗍", u: "𝗎", v: "𝗏",
        w: "𝗐", x: "𝗑", y: "𝗒", z: "𝗓",
        A: "𝖠", B: "𝖡", C: "𝖢", D: "𝖣", E: "𝖤", F: "𝖥", G: "𝖦", H: "𝖧", I: "𝖨", J: "𝖩", K: "𝖪",
        L: "𝖫", M: "𝖬", N: "𝖭", O: "𝖮", P: "𝖯", Q: "𝖰", R: "𝖱", S: "𝖲", T: "𝖳", U: "𝖴", V: "𝖵",
        W: "𝖶", X: "𝖷", Y: "𝖸", Z: "𝖹",
    };
